  ...
  <div id="dashboardView" class="hidden">
    ...
    <div class="main-layout">
      ...
      <div class="content-area">
        <iframe id="contentFrame" src="http://51.21.167.202:8020/" loading="lazy"></iframe>
      </div>
    </div>
  </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', async () => {
      const config = {
        ...
        modules: {
          attendance: 'http://51.21.167.202:7100/',
          leave: 'http://51.21.167.202:8037/',
          wfh: 'http://51.21.167.202:8026/',
          recruitment: 'http://51.21.167.202:8024/',
          payslip: 'http://51.21.167.202:8047/',
          tasks: 'http://51.21.167.202:8133/',
          offboarding: 'http://51.21.167.202:8035/',
          helpdesk: 'http://51.21.167.202:8042/'
        },
